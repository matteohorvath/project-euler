def function(n, array):
    counter = 0
    inside_array = []
    while counter < len(array) - n:
        num = 1
        for x in range(n):
            num *= array[counter + x]
        counter += 1
        inside_array.append(num)
    return max(inside_array)


array = [7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9, 2, 2, 5, 1, 1, 9, 6, 7, 4, 4, 2, 6, 5, 7, 4, 7, 4,
